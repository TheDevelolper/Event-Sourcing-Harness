...
public static class BuilderExtensions
{
    ...
    static string TempDevClientSecret = string.Empty;
        ...
        this IDistributedApplicationBuilder builder, ILogger logger, string authClientSecret)
       {
           ...
           TempDevClientSecret = authClientSecret;
        var keycloak =
    ...
    public static IHostApplicationBuilder AddAuthentication(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddAuthentication(options =>
            ...
            .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
            {
                ...
                options.ClientSecret = TempDevClientSecret; //TODO: From Keycloak Clients > Client details > Credentials (Tab)
